        ...
        if d1init == d2init:
            if d1speed == d2speed:
                ...
                if int(d1speed) > int(d2speed):
                    text = 'There was a tie\n%s goes first based on speed score' % dragon1
                    text2 = '%s moves first' % dragon1
                    text = text + '\n'+ text2
                    query = "update combattable set rank = 'waiting to move', story='A' where name = '%s'" % (dragon1)
                    query2 = "update combattable set rank = 'moving', story='A' where name = '%s'" % (dragon2)
                    cursor.execute(query)
                    ...
                    text = 'There was a tie\n%s goes first based on speed score' % dragon2
                    text2 = '%s moves first' % dragon1
                    text = text + '\n'+ text2
                    query = "update combattable set rank = 'waiting to move', story='A' where name = '%s'" % (dragon2)
                    query2 = "update combattable set rank = 'moving', story='A' where name = '%s'" % (dragon1)
                    cursor.execute(query)
                    cursor.execute(query2)
                    cnx.commit()
...
def regainessence(defender,attacker):
    ...
    if defender[2] == 'starting' and defender[2] == 'starting':
